    ...
    >
      <ScrollContainer>
        <ScrollPage>
          ...
          >
            <h2 className="font-heading block px-8 text-center text-[clamp(1.5rem,5vw,2.5rem)] font-light uppercase leading-[1.8] tracking-[0.3rem] text-zinc-500 sm:leading-[1.5] ">
        ...
        <ScrollPage>
          ...
          >
            <h3 className="font-paragraph block text-center text-[clamp(1.5rem,5vw,2.5rem)] font-[200] uppercase leading-tight tracking-[0.3rem] text-zinc-500">
