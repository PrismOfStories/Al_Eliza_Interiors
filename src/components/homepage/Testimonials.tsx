...
const testimonials: Testimonial[] = [
  {
    ...
    text: "Working with Al Eliza Interior Design on our office project was an absolute pleasure.From the very first concept presentation to the final handover, their team demonstrated remarkable creativity, professionalism, and attention to detail.",
    name: "VINOD",
    title: "CEO",
  ...
  },
  {
    ...
    text: "Al Eliza Interior Design brought our vision to life with exceptional creativity and precision. The team understood exactly what we wanted and delivered a space that blends functionality with refined elegance. Their professionalism and commitment to quality made the entire process seamless and rewarding.",
    name: "RUSSELL AHMED",
    title: "CEO",
  ...
  },
  {
    ...
    text: "Al Eliza Interior Design completely transformed my restaurant space. They understood my ideas from day one and turned them into a design that’s both stylish and welcoming. Every detail — from the lighting to the seating layout — was perfectly thought out. The result is a space our customers love and talk about. I truly appreciate their creativity and professionalism throughout the project.",
    name: "ASHFAK",
    title: "CEO",
