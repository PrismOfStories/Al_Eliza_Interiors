          ...
          <div>
            <h2 className="font-black  text-black space-y-4 font-heading text-center lg:text-start">
              <motion.span
                ...
                transition={{ duration: 0.7, ease: "easeOut" }}
                viewport={{ once: true, margin: "0px 0px -40% 0px" }}
                className="block w-full text-center text-3xl sm:text-4xl lg:text-6xl xl:text-7xl tracking-[0.6rem]"
              >
                YOUR DREAMS
              </motion.span>
              <motion.span
                ...
                viewport={{ once: true, margin: "0px 0px -40% 0px" }}
                className="block w-full text-center text-2xl sm:text-3xl lg:text-5xl xl:text-6xl tracking-[0.6rem]"
              >
                OUR EXPERTISE
              </motion.span>
            </h2>
