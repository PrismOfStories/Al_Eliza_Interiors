...
export default function ArchitectureHero() {
  return (
    <section className=" h-full bg-[#FAF7F0] px-4 sm:px-6 lg:px-8 flex items-center justify-center ">
      <div className="w-full max-w-[100rem] min-h-screen mx-auto h-full flex flex-col justify-between space-y-8 py-20 lg:py-40">
        <div className="w-full">
          <p className="text-center text-[10px] sm:text-lg uppercase tracking-[0.25em] text-brown font-medium">
            {" "}
            Established in 2021
          </p>
        </div>
        ...
        <div className="flex justify-between flex-col lg:flex-row items-center lg:items-stretch gap-10 lg:gap-0">
          <div>
            <div className="text-[140px] xl:text-9xl leading-[0.8] font-black text-[#333] tracking-tight">
              +4
            </div>
            <p className="text-[11px] uppercase tracking-[0.15em] text-[#777] mt-2 ml-1">
              Years of experience
            </p>
          </div>
          <div>
            <h1 className="font-black leading-[0.85] text-[#222] tracking-tight space-y-8">
          ...
          <div>
            ...
            <p className="text-[11px] uppercase tracking-[0.15em] text-[#777] mt-2 mr-1">
              Successful Projects
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between flex-col lg:flex-row items-center lg:items-stretch gap-10 lg:gap-0">
          <div>
            <p className="text-[14px] sm:text-[15px] leading-[1.7] text-[#666] max-w-[50ch] mx-auto lg:mx-0">
          ...
          <div>
            <p className="text-[14px] sm:text-[15px] leading-[1.7] text-[#666] max-w-[50ch] mx-auto lg:mx-0 lg:ml-auto text-left lg:text-right mb-5">
              Ready to begin?{" "}
